...
app = typer.Typer(
    help="DataExtractor CLI - Herramienta potente de extracción de datos."
)
...
def extract(
    ...
    type: str = typer.Option(
        "html", "--type", "-t", help="Tipo de fuente (html, api, spa, pdf, database)"
    ),
    output: Optional[str] = typer.Option(
        None, "--output", "-o", help="Archivo de salida (opcional)"
    ),
):
    """
